# Generated by Django 5.2.13 on 2026-04-10 23:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="editable_annotation_sets",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="users",
                through="core.CollectionUserAccess",
                to="core.collection",
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name="courses",
            field=models.ManyToManyField(
                blank=True, related_name="collections", to="core.course"
            ),
        ),
        migrations.CreateModel(
            name="Email",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "job_type",
                    models.CharField(
                        choices=[("preflight", "Preflight"), ("import", "Import")],
                        max_length=20,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="jobs",
                        to="core.legacymigrationrequest",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": [
                    "migration_resource__legacy_name",
                    "legacy_version",
                    "legacy_path",
                ],
            },
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="issues",
                        to="core.legacymigrationfiledecision",
                    ),
                ),
                (
                    "resolved_by",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="issues",
                        to="core.legacymigrationresource",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="resources",
            field=models.ManyToManyField(
                related_name="users", through="core.ResourceAccess", to="core.resource"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        upload_to=core.models.file_upload_path,
                        validators=[
                            core.models.validate_media_file,
                            core.models.validate_unique_checksum,
                        ],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subtitles_file",
                    models.FileField(
                        upload_to=core.models.subtitle_file_upload_path,
                        validators=[core.models.validate_subtitle_file],
                    ),
                ),
                (
                    "subtitles_temp_file",
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to=core.models.subtitle_temp_file_upload_path,
                        validators=[core.models.validate_subtitle_file],
                    ),
                ),
        ...
        migrations.AddField(
            ...
            name="courses",
            field=models.ManyToManyField(
                blank=True, through="core.UserCourses", to="core.course"
            ),
        ),
        ...
        migrations.AddConstraint(
            model_name="legacymigrationuserresolution",
            constraint=models.UniqueConstraint(
