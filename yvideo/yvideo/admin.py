...
class ResourceAdmin(VersionAdmin):
    list_display = ('name', 'media_type', 'requester_netid', 'copyrighted', 'views', 'created_at')
...
class ContentAdmin(VersionAdmin):
    ...
    list_filter = ('published', 'allow_definitions', 'allow_notes', 'allow_captions', 'created_at')
...
class ClipAdmin(VersionAdmin):
    ...
    list_filter = ('created_at',)
    search_fields = ('name', 'description', 'tags', 'owner__name', 'file__resource__name')
...
class SubtitleAdmin(VersionAdmin):
    ...
    search_fields = ('name', 'owner__name', 'file__resource__name', 'language__language')
